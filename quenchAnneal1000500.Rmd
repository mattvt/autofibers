...
quench1000  <- combineData(condition = "quench")
quench500   <- combineData(condition = "quench")
anneal1000  <- combineData(condition = "anneal")
anneal500   <- combineData(condition = "anneal")

all.quench  <- rbind(quench1000, quench500)
all.anneal  <- rbind(anneal1000, anneal500)

all         <- rbind(all.quench, all.anneal)
